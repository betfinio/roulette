...
const isObject = (item: unknown) => item !== null && isArray(item) === false && typeof item === 'object';

const isFunction = (item: unknown) => typeof item === 'function';

const isBoolean = (item: unknown) => typeof item === 'boolean';

const hasOwnPrototypeOfToString = (object: object) => object.toString !== Object.prototype.toString;
