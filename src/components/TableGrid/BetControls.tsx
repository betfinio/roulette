		...
		<div className="flex flex-col">
			<div className="w-[var(--min-width-sm)] flex flex-col gap-y-2">
				...
				<div className="flex w-full gap-2 items-center justify-center bg-[var(--bg-sec)] p-4 rounded-lg border-[var(--border-primary)] border-[1px]">
					...
					>
						<span className="whitespace-nowrap text-lg font-semibold">Place BET</span>
						<span className="whitespace-nowrap text-xs font-semibold">and WIN 234k</span>
					</button>
					<button type="button" className="text-xs text-white font-medium h-9 w-20 transition-all">
				...
				<div className="flex items-center gap-2 justify-between bg-[var(--bg-sec)] p-2 rounded-lg border-[var(--border-primary)] border-[1px]">
					...
					<motion.svg width="40" height="40" viewBox="0 0 154 154" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
						...
						<path
							...
							fill={getChipColor(activeChipValue)}
						/>
						<path d="M68.6221 70.9082L69.6313 70.9049L70.2836 69.1152H69.2689L68.6221 70.9082Z" fill={getChipColor(activeChipValue)} />
						<path
						...
						<path
							...
							fill={getChipColor(activeChipValue)}
						/>
						<path d="M80.9191 62.501C80.5797 62.501 80.2195 62.501 79.8372 62.501L77.624 68.6357H78.707L80.9191 62.501Z" fill={getChipColor(activeChipValue)} />
						<path d="M77.8795 70.9258L78.5324 69.1152H77.4489L76.7993 70.9165L77.2734 70.9203L77.8795 70.9258Z" fill={getChipColor(activeChipValue)} />
						<path
						...
						<path
							...
							fill={getChipColor(activeChipValue)}
						/>
						<text x="50%" y="50%" textAnchor="middle" dy=".3em" fill="#000" className="text-[36px] font-semibold">
