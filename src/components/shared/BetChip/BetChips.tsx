				...
				return (
					<div
						...
						style={{
							...
							color: isGhost ? 'rgba(255, 255, 255, 0.5)' : getChipColor(chip.amount),
						}}
					>
						<svg viewBox="0 0 154 154" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path
								...
								fill="currentColor"
							/>
							<path d="M68.6221 70.9082L69.6313 70.9049L70.2836 69.1152H69.2689L68.6221 70.9082Z" fill="currentColor" />
							<path
							...
							<path
								...
								fill="currentColor"
							/>
							<path d="M80.9191 62.501C80.5797 62.501 80.2195 62.501 79.8372 62.501L77.624 68.6357H78.707L80.9191 62.501Z" fill="currentColor" />
